...
from util import DoubleBuffer, assemble_matrix_from_tiles, generate_matrices, matrices_equal, mpi_setup, call_algorithm, create_algorithm_output, send, receive
...
def AG_A_COL_AG_A_ROW(m, k, n, px, py, skip_computation=False):
    # 1
...
def AG_A_COL_AG_B_COL(m, k, n, px, py, skip_computation=False):
    # 2
    comm, size, rank = mpi_setup()
...
def AG_A_COL_AG_B_ROW(m, k, n, px, py, skip_computation=False):
    # 3
    comm, size, rank = mpi_setup()
...
def AG_A_COL_RS_C_COL(m, k, n, px, py, skip_computation=False):
    # 4
    comm, size, rank = mpi_setup()
...
def AG_A_COL_RS_C_ROW(m, k, n, px, py, skip_computation=False):
    # 5
    comm, size, rank = mpi_setup()
...
def AG_A_ROW_AG_B_COL(m, k, n, px, py, skip_computation=False):
    # 6
    comm, size, rank = mpi_setup()
...
def AG_A_ROW_AG_B_ROW(m, k, n, px, py, skip_computation=False):
    # 7
    comm, size, rank = mpi_setup()
...
def AG_A_ROW_RS_C_COL(m, k, n, px, py, skip_computation=False):
    # 8
    comm, size, rank = mpi_setup()
...
def AG_A_ROW_RS_C_ROW(m, k, n, px, py, skip_computation=False):
    # 9
...
def AG_B_COL_AG_B_ROW(m, k, n, px, py, skip_computation=False):
    # 10
    comm, size, rank = mpi_setup()
...
def AG_B_COL_RS_C_COL(m, k, n, px, py, skip_computation=False):
    # 11
    comm, size, rank = mpi_setup()
...
def AG_B_COL_RS_C_ROW(m, k, n, px, py, skip_computation=False):
    # 12
    comm, size, rank = mpi_setup()
...
def AG_B_ROW_RS_C_COL(m, k, n, px, py, skip_computation=False):
    # 13
    comm, size, rank = mpi_setup()
...
def AG_B_ROW_RS_C_ROW(m, k, n, px, py, skip_computation=False):
    # 14
...
def RS_C_COL_RS_C_ROW(m, k, n, px, py, skip_computation=False):
    # 15
    comm, size, rank = mpi_setup()
...
# 1d algorithms
def AG_A_COL(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
...
def AG_A_ROW(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
...
def AG_B_COL(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
...
def AG_B_ROW(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
...
def RS_C_COL(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
...
def RS_C_ROW(m, k, n, px, py, skip_computation=False):
    comm, size, rank = mpi_setup()
