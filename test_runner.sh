...
VALID_ALGORITHMS=(
    ...
    "AG_A_COL_PARAMETERIZED_PREV"
    "AG_A_ROW_PARAMETERIZED_PREV"
    "AG_B_COL_PARAMETERIZED_PREV"
    "AG_B_ROW_PARAMETERIZED_PREV"
    "RS_C_COL_PARAMETERIZED_PREV"
    "RS_C_ROW_PARAMETERIZED_PREV"

    "AG_A_COL_PARAMETERIZED_NEXT"
    "AG_A_ROW_PARAMETERIZED_NEXT"
    "AG_B_COL_PARAMETERIZED_NEXT"
    "AG_B_ROW_PARAMETERIZED_NEXT"
    "RS_C_COL_PARAMETERIZED_NEXT"
    "RS_C_ROW_PARAMETERIZED_NEXT"
)
